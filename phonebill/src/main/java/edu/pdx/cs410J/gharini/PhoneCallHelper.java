...
public class PhoneCallHelper {
     ...
     * This method checks if the Start Date and end Date of the phone call is in the valid format. The valid format for time date/time
     ...
     * @param arg  : the date variable as string
     * @throws InvalidDateAndTimeException
     * This method checks if the Start time and end time is in the valid format. The valid format for time
